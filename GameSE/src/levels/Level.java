...
/**
 * Die Klasse Level repräsentiert ein Spiellevel mit Informationen über die Position von Objekten, Entitäten und anderen Elementen.
 */
...
public class Level {
    ...
    *
    * @param img Das Bild, das das Level repräsentiert.
    */
    ...
    /**
     * Gibt den Index des Sprites für eine bestimmte Position im Level zurück.
     *
     * @param x Die x-Koordinate der Position.
     * @param y Die y-Koordinate der Position.
     * @return Der Index des Sprites an der angegebenen Position.
     */
	...
	/**
     * Gibt die Level-Daten als 2D-Array zurück.
     *
     * @return Die Level-Daten.
     */
	...
	/**
     * Gibt den horizontalen Offset des Levels zurück.
     *
     * @return Der maximale horizontale Offset des Levels.
     */
	...
	/**
     * Gibt die Startposition des Spielers im Level zurück.
     *
	...
	/**
     * Gibt die Liste der Krabben im Level zurück.
     *
     * @return Die Liste der Krabben.
     */
	//USW...
