...
public class HelpMethods {
	...
	/**
     * Überprüft, ob sich ein Objekt an den gegebenen Koordinaten bewegen kann.
     *
     ...
     * @return         {@code true}, wenn das Objekt sich bewegen kann, {@code false} sonst.
     */
	...
	/**
     * Überprüft, ob ein Projektil das Level berührt.
     *
     * @param p       Das Projektil.
     * @param lvlData Die Level-Daten.
     * @return        {@code true}, wenn das Projektil das Level berührt, {@code false} sonst.
     */
    ...
    /**
     * Überprüft, ob ein Objekt auf dem Boden steht.
     *
     * @param hitbox  Die Hitbox des Objekts.
     * @param lvlData Die Level-Daten.
     * @return        {@code true}, wenn das Objekt auf dem Boden steht, {@code false} sonst.
     */
