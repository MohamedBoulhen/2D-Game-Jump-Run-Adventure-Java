...
/**
 * Eine Klasse, die das Management von Objekten im Spiel übernimmt, wie z.B. Tränke, Container, Projektile usw.
 */
public class ObjectManager {
	...
	/**
     * Konstruktor für die {@code ObjectManager}-Klasse.
     *
     * @param playing Die Instanz des {@code Playing}-Objekts.
     */
	...
	/**
	 * Überprüft, ob der Spieler von Stacheln berührt wurde. Falls ja, wird der Spieler getötet.
	 *
	 * @param p Der Spieler, der überprüft wird.
	 */
	...
	/**
	 * Überprüft, ob ein Feind von Stacheln berührt wurde. Falls ja, wird dem Feind Schaden zugefügt.
	 *
	 * @param e Der Feind, der überprüft wird.
	 */
	...
	/**
	 * Überprüft, ob ein Objekt von einem bestimmten Rechteck berührt wurde. Falls ja, wird die entsprechende Aktion ausgeführt.
	 *
	 * @param hitbox Das Rechteck, das die Berührung überprüft.
	 */
	...
	/**
	 * Wendet den Effekt eines Tranks auf den Spieler an.
	 *
	 * @param p Der Trank, dessen Effekt angewendet wird.
	 */
	...
	/**
	 * Überprüft, ob ein bestimmtes Rechteck mit Containern kollidiert ist. Falls ja, wird eine Animation ausgelöst, und ein Trank wird an der Kollisionsstelle erzeugt.
	 *
	 * @param attackbox Das Rechteck, das die Kollision überprüft.
	 */
	...
	/**
	 * Lädt die Objekte für ein neues Level.
	 *
	 * @param newLevel Das neue Level, dessen Objekte geladen werden sollen.
	 */
	...
	/**
	 * Zeichnet die Grasobjekte auf dem Bildschirm.
	 *
	 * @param g          Die Graphics-Instanz zum Zeichnen.
	 * @param xLvlOffset Der Versatz des Levels auf der X-Achse.
	 */
	...
	/**
	 * Zeichnet die Hintergrundbäume auf dem Bildschirm.
	 *
	 * @param g          Die Graphics-Instanz zum Zeichnen.
	 * @param xLvlOffset Der Versatz des Levels auf der X-Achse.
	 */
	...
	/**
	 * Zeichnet die Projektile auf dem Bildschirm.
	 *
	 * @param g          Die Graphics-Instanz zum Zeichnen.
	 * @param xLvlOffset Der Versatz des Levels auf der X-Achse.
	 */
	...
	/**
	 * Zeichnet die Kanonen auf dem Bildschirm.
	 *
	 * @param g          Die Graphics-Instanz zum Zeichnen.
	 * @param xLvlOffset Der Versatz des Levels auf der X-Achse.
	 */
	...
	/**
	 * Zeichnet die Fallen auf dem Bildschirm.
	 *
	 * @param g          Die Graphics-Instanz zum Zeichnen.
	 * @param xLvlOffset Der Versatz des Levels auf der X-Achse.
	 */
	...
	/**
	 * Zeichnet die Container auf dem Bildschirm.
	 *
	 * @param g          Die Graphics-Instanz zum Zeichnen.
	 * @param xLvlOffset Der Versatz des Levels auf der X-Achse.
	 */
	...
	/**
	 * Zeichnet die Tränke auf dem Bildschirm.
	 *
	 * @param g          Die Graphics-Instanz zum Zeichnen.
	 * @param xLvlOffset Der Versatz des Levels auf der X-Achse.
	 */
