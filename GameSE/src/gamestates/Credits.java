...
/**
 * Die Credits-Klasse repräsentiert den Spielzustand, der die Credits des Spiels anzeigt.
 * Diese Klasse erbt von der abstrakten Klasse State und implementiert das Statemethods-Interface.
 * Die Credits enthalten eine Hintergrundgrafik, eine Liste von Entitäten (ShowEntity) und zeigen animierte Figuren während des Bildlaufs an.
 */
...
public class Credits extends State implements Statemethods {
	...
	private ArrayList<ShowEntity> entitiesList;
	 ...
	 /**
     * Konstruktor für die Credits-Klasse.
     * Initialisiert Hintergrundbilder, Position und Größe, sowie eine Liste von ShowEntity-Objekten.
     *
     * @param game Das Game-Objekt, zu dem dieser Spielzustand gehört.
     */
	...
	/**
	 * Die Methode loadEntities initialisiert die Liste von ShowEntity-Objekten für die Credits.
	 * Die Liste enthält verschiedene ShowEntity-Objekte mit animierten Idle-Animationen, die während der Credits angezeigt werden.
	 * Jede ShowEntity repräsentiert eine animierte Figur mit einer spezifischen Position auf dem Bildschirm.
	 */
	...
	private class ShowEntity {
		...
		/**
	     * Zeichnet das aktuelle Bild der Idle-Animation auf den Grafikkontext.
	     *
	     * @param g Der Grafikkontext, auf dem die Figur gezeichnet wird.
	     */
		public void draw(Graphics g) {
